...
import animationData from '../assets/Animation - 1710349901946.json'
...
const Auth = () => {
    ...
    return (
        <section className="relative h-screen w-screen bg-black flex flex-col overflow-hidden">
            ...
            <div className='flex items-start justify-center lg:gap-20 gap-10 p-2 lg:flex-row flex-col-reverse'>
                <Lottie animationData={animationData} loop autoplay height={400} width={400} />
                <div className='flex flex-col w-full gap-5 lg:w-1/2 z-10 lg:min-h-[650px] mt-5'>
